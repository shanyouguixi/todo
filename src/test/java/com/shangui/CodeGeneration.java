...
public class CodeGeneration {
    //项目路径
    private static String canonicalPath = "D://code//todo";

    //基本包名
    private static String basePackage = "com.shangui";
    //作者
    ...
    private static String url = "jdbc:mysql://localhost:3306/todo?serverTimezone=UTC ";
...
//                        .setExclude(new String[]{"test_","t_","z_"}) // 排除生成的表
                        // 自定义实体父类
